...
-   Optional: The "Tidy Your Data" tutorial on [Rstudio Cloud Primers](https://rstudio.cloud/learn/primers)
...
Send this email by **January 20th** and we will assign un-teamed folks at the beginning of the following week. Project 1 is due in no time. See [schedule](/schedule/) for all the important project dates.
...
[^1]: If you have not installed this package already, you must use `install.packages("tidyverse")` prior to the `library()` call you see below.
...
blogdown::shortcode("youtube", "D6WqHA8TDWQ")
```
-->
````
